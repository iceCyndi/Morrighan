...
public class MFUIUnit : MonoBehaviour
{
    ...
    public UILabel RegisterLabel(string name, Transform rootTran = null)
    {
        ...
        if (rootTran == null)
        {
            lbl = m_myTransform.FindChild(MFUIUtils.GetFullName(name)).GetComponentsInChildren<UILabel>(true)[0];
        }
        else
        {
            lbl = rootTran.FindChild(name).GetComponentsInChildren<UILabel>(true)[0];
        }
    ...
    public UISprite RegisterSprite(string name, Transform rootTran = null)
    {
        ...
        if (rootTran == null)
        {
            sp = m_myTransform.FindChild(MFUIUtils.GetFullName(name)).GetComponentsInChildren<UISprite>(true)[0];
        }
        else
        {
            sp = rootTran.FindChild(name).GetComponentsInChildren<UISprite>(true)[0];
        }
    ...
    public UITexture RegisterTexture(string name, Transform rootTran = null)
    {
        ...
        if (rootTran == null)
        {
            tex = m_myTransform.FindChild(MFUIUtils.GetFullName(name)).GetComponentsInChildren<UITexture>(true)[0];
        }
        else
        {
            tex = rootTran.FindChild(name).GetComponentsInChildren<UITexture>(true)[0];
        }
    ...
    public MFUIButtonHandler RegisterButtonHandler(string name, Transform rootTran = null)
    {
        ...
        if (rootTran == null)
        {
            bh = m_myTransform.FindChild(MFUIUtils.GetFullName(name)).GetComponentsInChildren<MFUIButtonHandler>(true)[0];
        }
        else
        {
            bh = rootTran.FindChild(name).GetComponentsInChildren<MFUIButtonHandler>(true)[0];
        }
