...
public class ChooseServerUIGrid : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        m_lblServerName = m_myTransform.FindChild("ChooseServerUIServerBtnText").GetComponentsInChildren<UILabel>(true)[0];
    }

    void Start()
    {
        m_lblServerName.text = m_strServerStatus;
    }
